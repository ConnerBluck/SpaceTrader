 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Kendall Abbott");
		  toPrint += p1.toString("kabbott6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Julia Litrel");
		  toPrint += p2.toString("jlitrel6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Conner Bluck");
		  toPrint += p3.toString("cbluck3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Santiago Pozuelo");
                  toPrint += p4.toString("spozuelo3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Javier Arevalo");
                  toPrint += p5.toString("jarevalo8");
