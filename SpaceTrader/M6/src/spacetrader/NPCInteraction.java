...
public class NPCInteraction extends Controller {
    ...
    private int price = 4;
    private JPanel iconHolder = new JPanel();
    ...
    void traderDisplay(Item item) {
        ...
        JPanel traderIcon = new JPanel();
        traderIcon.setLayout(null);
        traderIcon.setOpaque(false);
        traderIcon.add(iconHolder);
        JFrame temp = new JFrame();
        temp.add(traderIcon);
        temp.setVisible(true);
        traderDialog.setMinimumSize(new Dimension(600, 600));
        traderDialog.setMaximumSize(new Dimension(600, 600));
        ...
        robTrader.addActionListener((ActionEvent e) -> {
            ...
            try {
                if (Trader.fighterCheck(Game.playerOne)) {
                    ...
                    Game.playerOne.getShip().setHealth(
                            Game.playerOne.getShip().getHealth() - 10);
    ...
    void banditDisplay() {
        ...
        banditDialog.setMinimumSize(new Dimension(600, 600));
        banditDialog.setMaximumSize(new Dimension(600, 600));
        ...
        //banditDialog.setVisible(true);
        //System.out.println("Bandit opening");
    ...
    void policeDisplay() {
        ...
        policeDialog.setMinimumSize(new Dimension(600, 600));
        policeDialog.setMaximumSize(new Dimension(600, 600));
        ...
        //System.out.println("Police opening");
    }
    ...
    protected void iconSetup(String s) {
        ...
        try {
            //iconHolder.setLayout(null);
            JLabel backgroundPicture = new JLabel();
            //backgroundPicture.setBounds(0, 0, 800, 650);
            if (s.equals("bandit")) {
